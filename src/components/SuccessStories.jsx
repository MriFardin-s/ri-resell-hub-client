...
export default function SuccessStories() {
  ...
  return (
    <section className="bg-slate-50 dark:bg-neutral-900/30 py-16 lg:py-24 overflow-hidden transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-neutral-900 dark:text-neutral-100 tracking-tight">
            Loved by Thousands of <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-amber-600 dark:from-theme-yellow-primary dark:to-amber-500">Buyers & Sellers</span>
          </h2>
        ...
        >
          {stories.map((item, index) => (
            <motion.div 
              ...
              className="bg-white dark:bg-neutral-950 rounded-2xl p-8 shadow-md border border-gray-100 dark:border-neutral-900 flex flex-col justify-between relative hover:shadow-xl dark:hover:shadow-neutral-950/50 transition-all duration-300 group"
            >
              <div className="absolute top-0 right-0 bg-theme-yellow-primary text-neutral-900 text-xs font-bold px-4 py-1.5 rounded-bl-xl rounded-tr-2xl shadow-sm">
                {item.badge}
              </div>

              <div className="space-y-6">
                <div className="flex items-center space-x-1 text-theme-yellow-primary">
                  {[...Array(5)].map((_, i) => (
                ...
                <p className="text-gray-600 dark:text-neutral-400 text-sm leading-relaxed italic">
                  {item.story}
                </p>
              </div>

              <div className="flex items-center space-x-4 pt-6 mt-6 border-t border-gray-100 dark:border-neutral-900">
                <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-theme-yellow-primary flex-shrink-0 bg-neutral-100 dark:bg-neutral-800">
                  <img 
                    src={item.image} 
                    alt={item.name} 
