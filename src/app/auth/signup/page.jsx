      ...
      <Card className="w-full max-w-md bg-neutral-800/80 backdrop-blur-md border border-neutral-700/50 shadow-2xl p-6 rounded-2xl relative z-10 text-white">
        ...
        <Card.Content className="p-0 space-y-4">
          ...
          <Form onSubmit={handleSignUp} className="space-y-4 w-full">
            <div className="flex flex-col items-center justify-center space-y-2 w-full">
              <label className="relative group cursor-pointer flex flex-col items-center justify-center w-20 h-20 rounded-full border-2 border-dashed border-neutral-600 hover:border-yellow-400 overflow-hidden transition bg-neutral-900/50">
                {imagePreview ? (
                  <img src={imagePreview} alt="Preview" className="w-full h-full object-cover rounded-full" />
                ) : (
                  <div className="flex flex-col items-center justify-center text-gray-400 group-hover:text-yellow-400 transition">
                    <Plus className="w-5 h-5" />
                  </div>
                )}
                <input type="file" accept="image/*" className="hidden" onChange={handleImageChange} />
              </label>
              <span className="text-[11px] text-gray-400 font-medium">Upload Profile Picture (Max 5MB)</span>
            </div>

            <TextField className="w-full space-y-1">
              <Label className="text-gray-300 font-medium text-xs pl-1">Full Name</Label>
              <div className="relative">
                <Person className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-500 w-4 h-4" />
                <Input
                  type="text"
          ...
          <div className="relative flex items-center justify-center my-6">
            ...
            <span className="absolute bg-neutral-800 px-3 text-[11px] text-gray-500 uppercase font-semibold tracking-wider">Or continue with</span>
          </div>
        ...
        <Card.Footer className="flex justify-center p-0 mt-6">
          <p className="text-xs text-gray-400">
            ...
            <Link href="/auth/signin" className="text-yellow-400 font-bold hover:underline transition">
              Sign In
            </Link>
          </p>
        </Card.Footer>
