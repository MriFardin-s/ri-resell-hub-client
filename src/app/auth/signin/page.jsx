...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900 flex items-center justify-center p-4 relative overflow-hidden transition-colors">
      ...
      {/* Main Card */}
      <Card className="w-full max-w-md bg-white/90 dark:bg-neutral-800/80 backdrop-blur-md border border-neutral-200 dark:border-neutral-700/50 shadow-2xl p-6 rounded-2xl relative z-10 text-neutral-900 dark:text-white transition-colors">
          ...
          <Form onSubmit={handleSignIn} className="space-y-4 w-full">
            ...
            <TextField className="w-full space-y-1">
              <div className="flex justify-between items-center pl-1 pr-1">
                <Label className="text-neutral-700 dark:text-gray-300 font-medium text-xs">Password</Label>
                <Link href="/auth/forgot-password" className="text-[11px] text-yellow-600 dark:text-yellow-400/80 hover:text-yellow-500 dark:hover:text-yellow-400 transition">
                  Forgot?
                </Link>
              </div>
              <div className="relative">
